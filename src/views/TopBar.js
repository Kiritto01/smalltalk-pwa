...
const TopBar = (props) => {
    ...
    {show && <PopUp show={show} setShow={setShow} avatar={userLogo} head1={"Szymon"} imagine3={fbLogo} imagine4={instLogo} instaInfo={"Szymon Kowal"} fbInfo={"Szymon Kowal"} clas={'profile contentt'}/>}
    </div>
};
